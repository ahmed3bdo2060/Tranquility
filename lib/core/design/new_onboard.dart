...
class NewOnBoardView extends StatefulWidget {
  const NewOnBoardView({super.key});

  @override
  State<NewOnBoardView> createState() => _NewOnBoardViewState();
}

class _NewOnBoardViewState extends State<NewOnBoardView> {
  ...
  void initState() {
    ...
    listContentConfig.add(
      ContentConfig(
        ...
        backgroundNetworkImage: "https://th.bing.com/th/id/R.415058df456a4e2fad958b7f05aa06a8?rik=sdiU4nxQeJtCwg&pid=ImgRaw&r=0",
